...
PLOCALES="ar be bg br ca cs da de ee el eo es et fi fr hr hu it ja mk nl pl pt
 pt_BR ru se sk sl sr sr@latin sv sw uk ur_PK vi zh_CN zh_TW"
...
SLOT="0"
KEYWORDS=""
IUSE="crypt dbus debug doc enchant extras jingle iconsets +qt5 -qt4 spell sql ssl
xscreensaver plugins whiteboarding webkit"
