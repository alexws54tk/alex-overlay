...
SRC_URI="http://gpo.al54.tk/gentoo-distfiles/${P}.tar.xz
	http://gpo.al54.tk/gentoo-distfiles/${P}-patchset-1.tar.xz"
...
DOCS="README RELEASE_NOTES TODO" # ChangeLog is bogus, see git instead http://anongit.freedesktop.org/git/xdg/xdg-utils.git
